...
describe('Home', () => {
  ...
  it('Should present fit chart on success', async () => {
    ...
    const categoryOneExerciseOneName = screen.getByTestId(
      'category-1-exercise-1-name',
    );
    const categoryOneExerciseOneEquipment = screen.getByTestId(
      'category-1-exercise-1-equipment',
    );
    const categoryOneExerciseOneSeries = screen.getByTestId(
      'category-1-exercise-1-series',
    );
    const categoryOneExerciseOneRepts = screen.getByTestId(
      'category-1-exercise-1-repts',
    );
    const categoryOneExerciseOneWeight = screen.getByTestId(
      'category-1-exercise-1-weight',
    );
    const categoryOneExerciseTwoName = screen.getByTestId(
      'category-1-exercise-2-name',
    );
    const categoryOneExerciseTwoEquipment = screen.getByTestId(
      'category-1-exercise-2-equipment',
    );
    const categoryOneExerciseTwoSeries = screen.getByTestId(
      'category-1-exercise-2-series',
    );
    const categoryOneExerciseTwoRepts = screen.getByTestId(
      'category-1-exercise-2-repts',
    );
    const categoryOneExerciseTwoWeight = screen.getByTestId(
      'category-1-exercise-2-weight',
    );
    const categoryOneExerciseThreeName = screen.getByTestId(
      'category-1-exercise-3-name',
    );
    const categoryOneExerciseThreeEquipment = screen.getByTestId(
      'category-1-exercise-3-equipment',
    );
    const categoryOneExerciseThreeSeries = screen.getByTestId(
      'category-1-exercise-3-series',
    );
    const categoryOneExerciseThreeRepts = screen.getByTestId(
      'category-1-exercise-3-repts',
    );
    const categoryOneExerciseThreeWeight = screen.getByTestId(
      'category-1-exercise-3-weight',
    );
    const categoryTwo = screen.getByTestId('exercises-category-2');
    const categoryTwoExerciseOneName = screen.getByTestId(
      'category-2-exercise-1-name',
    );
    const categoryTwoExerciseOneEquipment = screen.getByTestId(
      'category-2-exercise-1-equipment',
    );
    const categoryTwoExerciseOneSeries = screen.getByTestId(
      'category-2-exercise-1-series',
    );
    const categoryTwoExerciseOneRepts = screen.getByTestId(
      'category-2-exercise-1-repts',
    );
    const categoryTwoExerciseOneWeight = screen.getByTestId(
      'category-2-exercise-1-weight',
    );
    const categoryTwoExerciseTwoName = screen.getByTestId(
      'category-2-exercise-2-name',
    );
    const categoryTwoExerciseTwoEquipment = screen.getByTestId(
      'category-2-exercise-2-equipment',
    );
    const categoryTwoExerciseTwoSeries = screen.getByTestId(
      'category-2-exercise-2-series',
    );
    const categoryTwoExerciseTwoRepts = screen.getByTestId(
      'category-2-exercise-2-repts',
    );
    const categoryTwoExerciseTwoWeight = screen.getByTestId(
      'category-2-exercise-2-weight',
    );
    ...
    expect(categoryOneExerciseOneEquipment).toHaveTextContent(
      'any_equipment_1',
    );
    ...
    expect(categoryOneExerciseThreeName).toHaveTextContent(
      'any_exercise_name_3',
    );
    expect(categoryOneExerciseThreeEquipment).toHaveTextContent(
      'any_equipment_3',
    );
    ...
    expect(categoryTwoExerciseOneEquipment).toHaveTextContent(
      'any_equipment_4',
    );
    ...
    expect(categoryTwoExerciseTwoEquipment).toHaveTextContent(
      'any_equipment_5',
    );
